 ...
 *6)emptycol         */
static const char *colors[] = {"#4c4c4c","#1c1c1c","#7a8c5c","#ff6666","#cc9933","#0d131a","#000000"};
...
static key keys[] = {
    ...
    // Maximize and move
    // vertically left
    {  MOD |SHIFT,        XK_Left,          maxhalf,           {.i=TWOBWM_MAXHALF_VERTICAL_LEFT}},
    // vertically right
    {  MOD |SHIFT,        XK_Right,          maxhalf,           {.i=TWOBWM_MAXHALF_VERTICAL_RIGHT}},
    // horizontally left
    ...
    {  MOD |SHIFT,        XK_Return,     start,             {.com = rofi}},
    ...
    // Change current workspace
       ...
       DESKTOPCHANGE(     XK_e,                             2)
       DESKTOPCHANGE(     XK_r,                             3)
       DESKTOPCHANGE(     XK_t,                             4)
       DESKTOPCHANGE(     XK_y,                             5)
       DESKTOPCHANGE(     XK_u,                             6)
       DESKTOPCHANGE(     XK_i,                             7)
       DESKTOPCHANGE(     XK_o,                             8)
       DESKTOPCHANGE(     XK_p,                             9)
};
